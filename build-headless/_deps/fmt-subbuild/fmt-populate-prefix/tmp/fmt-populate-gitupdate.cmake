...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "12.1.0"
  WORKING_DIRECTORY "/tmp/workspace/Giuseppe-Bianc/Vantablade/build-headless/_deps/fmt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/tmp/workspace/Giuseppe-Bianc/Vantablade/build-headless/_deps/fmt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/tmp/workspace/Giuseppe-Bianc/Vantablade/build-headless/_deps/fmt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
