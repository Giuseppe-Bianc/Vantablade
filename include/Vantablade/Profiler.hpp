...
//   Example:
//     {
//         VND_GPU_ZONE(ctx, cmd, "Frame::GPU");
//         renderScene(cmd);
//     }
//
// VND_GPU_COLLECT(ctx, cmd)
...
// ---------------------------------------------------------------------------
#ifdef VANTABLADE_PROFILING
#define VND_GPU_ZONE(ctx, cmd, name) TracyVkZone(ctx, cmd, name)
#define VND_GPU_COLLECT(ctx, cmd) TracyVkCollect(ctx, cmd)
#else
#define VND_GPU_ZONE(ctx, cmd, name) ((void)0)
#define VND_GPU_COLLECT(ctx, cmd) ((void)0)
#endif
